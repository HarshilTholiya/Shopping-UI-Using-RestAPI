                  ...
                  child: PageView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Image.network(snapshot.data![1]['MobileImage1'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![1]['MobileImage2'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![1]['MobileImage3'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![1]['MobileImage4'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![1]['MobileImage5'].toString()),
                      ),
                    ],
                  ),
                  flex: 4,
                        ...
                        Expanded(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Center(
                                child: Text(
                                  '₹'+snapshot.data![0]['MobilePrice'].toString()+'K',                                     style: TextStyle(
                                      fontSize: 30,
                                      fontWeight: FontWeight.bold),
                                ),
                              ),
