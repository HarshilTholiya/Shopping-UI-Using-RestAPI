                  ...
                  child: PageView(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Image.network(snapshot.data![0]['MobileImage1'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![0]['MobileImage2'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![0]['MobileImage3'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![0]['MobileImage4'].toString()),
                      ),
                      Container(
                        margin: EdgeInsets.all(5),
                        decoration: BoxDecoration(
                        ...
                        child: Image.network(snapshot.data![0]['MobileImage5'].toString()),
                      ),
                    ],
                  ),
                  flex: 4,
